...
sgd = SGD(lr=0.01,momentum=0.9) #OPTIMIZER
...
for i in range(len(saveImportLayersIndexes)-1): #MINUS HE LAST LAYER (OUTPUT)
    if ('NM_Layer' + str(i) not in history.keys()):
        ...
        counter = 0
        batch_size = 64
        datagen.modelToPredict = nextModelToPredict
